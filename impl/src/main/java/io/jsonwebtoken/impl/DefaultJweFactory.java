...
public class DefaultJweFactory {
    ...
    public DefaultJweFactory() {
        this(Decoders.BASE64URL, new RuntimeClasspathDeserializerLocator<Map<String, Object>>().getInstance(),
            EncryptionAlgorithms.A256GCM, new DisabledDecryptionKeyResolver());
    }

    public DefaultJweFactory(Decoder<String, byte[]> base64UrlDecoder, Deserializer<Map<String, Object>> deserializer,
        ...
        this.decryptionKeyResolver = Assert.notNull(decryptionKeyResolver, "DecryptionKeyResolver cannot be null.");
    }
